...
public struct Company {
  ...
  public var description_p: Company.Description {
    get {return _description_p ?? Company.Description()}
  ...
  public var logo: Company.Logo {
    get {return _logo ?? Company.Logo()}
    set {_logo = newValue}
  }
  ...
  public var largeLogo: Company.Logo {
    get {return _largeLogo ?? Company.Logo()}
  ...
  public var mapLogo: Company.Logo {
    get {return _mapLogo ?? Company.Logo()}
  ...
  public var mapGreyLogo: Company.Logo {
    get {return _mapGreyLogo ?? Company.Logo()}
  ...
  fileprivate var _description_p: Company.Description? = nil
  fileprivate var _logo: Company.Logo? = nil
  fileprivate var _largeLogo: Company.Logo? = nil
  fileprivate var _mapLogo: Company.Logo? = nil
  fileprivate var _mapGreyLogo: Company.Logo? = nil
}

// MARK: - Code below here is support for the SwiftProtobuf runtime.

extension Company: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "Company"
...
extension Company.Logo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Company.protoMessageName + ".Logo"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "x2"),
    2: .same(proto: "x3"),
  ]
  ...
  public static func ==(lhs: Company.Logo, rhs: Company.Logo) -> Bool {
...
extension Company.Description: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Company.protoMessageName + ".Description"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "en"),
    2: .same(proto: "lv"),
    3: .same(proto: "ru"),
  ...
  public static func ==(lhs: Company.Description, rhs: Company.Description) -> Bool {
...
extension Company.Query: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Company.protoMessageName + ".Query"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  public static func ==(lhs: Company.Query, rhs: Company.Query) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Company.Response: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Company.protoMessageName + ".Response"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Company.Response, rhs: Company.Response) -> Bool {
